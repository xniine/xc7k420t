...
module eth_virtio_pkt_tx #(
    ...
    function [4:0] skb_tkeep2n(input [15:0] tkeep);
        case (tkeep)
            16'h0000: skb_tkeep2n = 5'h00;
            16'h0001: skb_tkeep2n = 5'h01;
            16'h0003: skb_tkeep2n = 5'h02;
            16'h0007: skb_tkeep2n = 5'h03;
            16'h000F: skb_tkeep2n = 5'h04;
            16'h001F: skb_tkeep2n = 5'h05;
            16'h003F: skb_tkeep2n = 5'h06;
            16'h007F: skb_tkeep2n = 5'h07;
            16'h00FF: skb_tkeep2n = 5'h08;
            16'h01FF: skb_tkeep2n = 5'h09;
            16'h03FF: skb_tkeep2n = 5'h0A;
            16'h07FF: skb_tkeep2n = 5'h0B;
            16'h0FFF: skb_tkeep2n = 5'h0C;
            16'h1FFF: skb_tkeep2n = 5'h0D;
            16'h3FFF: skb_tkeep2n = 5'h0E;
            16'h7FFF: skb_tkeep2n = 5'h0F;
            16'hFFFF: skb_tkeep2n = 5'h10;
            default: begin
                skb_tkeep2n = 5'h10;
            end
        endcase
    ...
    function [255:0] skb_value(input [127:0] a, input [127:0] b, input [15:0] k, input [4:0] c);
        reg [127:0] v;
        begin
            case (k)
            ...
            case (c)
                5'h00: skb_value =  v;
                5'h01: skb_value = {v,b[0+:  8]};
                5'h02: skb_value = {v,b[0+: 16]};
                5'h03: skb_value = {v,b[0+: 24]};
                5'h04: skb_value = {v,b[0+: 32]};
                5'h05: skb_value = {v,b[0+: 40]};
                5'h06: skb_value = {v,b[0+: 48]};
                5'h07: skb_value = {v,b[0+: 56]};
                5'h08: skb_value = {v,b[0+: 64]};
                5'h09: skb_value = {v,b[0+: 72]};
                5'h0A: skb_value = {v,b[0+: 80]};
                5'h0B: skb_value = {v,b[0+: 88]};
                5'h0C: skb_value = {v,b[0+: 96]};
                5'h0D: skb_value = {v,b[0+:104]};
                5'h0E: skb_value = {v,b[0+:112]};
                5'h0F: skb_value = {v,b[0+:120]};
                default: begin
                    skb_value = {v,b};
                end
            endcase
    ...
    function [15:0] skb_tkeep(input [4:0] cnt);
        case (cnt)
            5'h0: skb_tkeep = 16'hFFFF;
            5'h1: skb_tkeep = 16'h0001;
            5'h2: skb_tkeep = 16'h0003;
            5'h3: skb_tkeep = 16'h0007;
            5'h4: skb_tkeep = 16'h000F;
            5'h5: skb_tkeep = 16'h001F;
            5'h6: skb_tkeep = 16'h003F;
            5'h7: skb_tkeep = 16'h007F;
            5'h8: skb_tkeep = 16'h00FF;
            5'h9: skb_tkeep = 16'h01FF;
            5'hA: skb_tkeep = 16'h03FF;
            5'hB: skb_tkeep = 16'h07FF;
            5'hC: skb_tkeep = 16'h0FFF;
            5'hD: skb_tkeep = 16'h1FFF;
            5'hE: skb_tkeep = 16'h3FFF;
            5'hF: skb_tkeep = 16'h7FFF;
            default: begin
                skb_tkeep = 16'hFFFF;
            end
        endcase
    ...
    wire [ 4:0] s_axis_tkeep2n    = s_axis_tvalid ? skb_tkeep2n(s_axis_tkeep) : 5'h0;
    ...
    always @(posedge clk) begin
        ...
        if (s_axis_eof && s_axis_int_tready) begin
            ...
            case ({s_axis_update,s_axis_int_update})
                2'b11: begin
                    {s_axis_val,s_axis_int_tdata} <= skb_value(s_axis_tdata, s_axis_val, s_axis_tkeep, s_axis_cnt - 5'h10);
                ...
                2'b10: begin
                    if (!s_axis_int_tvalid) begin
                        {s_axis_val,s_axis_int_tdata} <= skb_value(s_axis_tdata, s_axis_int_tdata, s_axis_tkeep, s_axis_cnt);
                        ...
                        case ({s_axis_tvalid && s_axis_tlast,s_axis_next_cnt[4:4] && !s_axis_next_cnt[3:0]})
                            2'b11: begin
                                s_axis_int_tkeep <= skb_tkeep(s_axis_next_cnt[4:0]);
                                s_axis_int_tlast <= 1'h1;
                            end 
                            2'b01, 2'b00: begin
                                s_axis_int_tkeep <= {16{1'h1}};
                        ...
                        s_axis_val <= skb_value(s_axis_tdata, s_axis_val, s_axis_tkeep, s_axis_cnt - 5'h10);
                        s_axis_cnt <= s_axis_tkeep2n + s_axis_cnt;
                    end
    ...
    always @(posedge clk) begin
        ...
        if (!m_axis_tvalid || m_axis_tvalid && m_axis_tready) begin
            ...
            if (m_axis_x1c) begin
                m_axis_tdata  <= m_axis_val[96+:32];
                m_axis_tkeep  <= m_axis_msk[12+: 4];
                m_axis_tvalid <= 1'h1;
                m_axis_tlast  <= 1'h1;
                ...
                m_axis_val    <= m_axis_int_tdata;
                m_axis_msk    <= m_axis_int_tkeep;
                ...
                case (m_axis_cnt)
                    8'h0: begin
                        ...
                        if (m_axis_int_tvalid && m_axis_int_tlast && m_axis_int_tkeep[12+:4]) begin
                            m_axis_tdata  <= m_axis_int_tdata[96+:32];
                            m_axis_tkeep  <= m_axis_int_tkeep[12+: 4];
                            m_axis_tvalid <= 1'h1;
                            m_axis_tlast  <= 1'h1;
                        end else
                        if (m_axis_int_tvalid && m_axis_int_tlast != 1'h1) begin
                            m_axis_cnt    <= m_axis_cnt + 1'h1;
                        end
                    end
                    8'h1: begin
                        m_axis_tdata      <= {m_axis_int_tdata[0+:96],m_axis_val[96+:32]};
                        m_axis_tkeep      <= {m_axis_int_tkeep[0+:12],m_axis_msk[12+: 4]};
                        m_axis_tvalid     <=  m_axis_int_tvalid;
                        m_axis_tlast      <= 1'h0;
                        m_axis_x1c        <= 1'h0;
                        ...
                        if (m_axis_int_tvalid && m_axis_int_tlast) begin
                            m_axis_tlast  <= 1'h1;
                            m_axis_cnt    <= 8'h0;
                        end
                    end
