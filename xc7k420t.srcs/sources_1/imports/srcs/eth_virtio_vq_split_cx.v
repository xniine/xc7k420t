...
module eth_virtio_vq_split_cx (
    ...
    localparam VIRQ_WRITE_STAT = 8'h6;
    localparam VIRQ_WRITE_USED = 8'h7;
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            vio_int_indx    <=  16'h0;
            vio_int_f_av    <=  16'h0; // Flags for Availabe Ring
            ...
            case (vio_int_stat)
                ...
                8'h4: begin
                    ...
                    if (tlp_rx_valid && tlp_rx_ready && tlp_rx_tkeep[0+:16] == 16'hFFFF) begin
                        ...
                        if (tlp_rx_tdata[97+:1]) begin // VIRTQ_DESC_F_WRITE
                            ...
                            // RQ (MWr) to Host: virtq->desc[*]->status
                            tlp_wr_valid <= 1'h1;
                            tlp_wr_tlast <= 1'h1;
                            tlp_wr_tdata <= 64'h0;
                ...
                8'h7: begin
                    ...
                    tlp_wr_tdata[32+:32] <= vio_int_size;
    ...
    always @(posedge clk) begin
        ...
        if (tlp_rx_valid && tlp_rx_ready && tlp_rx_tkeep[0+:16] == 16'hFFFF) begin
            m_axis_ctl_tlast <= tlp_rx_tdata[97+:1];
        end else begin
            m_axis_ctl_tlast <= 1'h0;
        end
    end
